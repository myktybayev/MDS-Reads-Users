...
//
//public class UserFragmentCopy extends Fragment implements View.OnClickListener {
...
//        new GetUsersAsyncTask(getActivity(), recyclerView, mSwipeRefreshLayout, version).execute();
//    }
//
